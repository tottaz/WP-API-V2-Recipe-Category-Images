...
/**
 * Plugin Name: WP-API-V2-Recipe-Category-Images
...
if ( is_plugin_active('rest-api/plugin.php') ) {
	new RecipeCategoryImageDataPlugin();
}

class RecipeCategoryImageDataPlugin {
	...
	function add_custom_data() {
		...
		register_rest_field('recipe_category', 'img', array(
